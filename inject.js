...
// Override IDB preload cache ASAP. The page's inline script reads react-query-cache
// from IndexedDB into __PRELOADED_IDB_CACHE__ BEFORE our module scripts run.
// By overriding here, the app gets undefined and falls back to a fresh network fetch
// (which our fetch override patches for Pro plan spoofing).
try {
...
// Clear GrowthBook/Statsig localStorage caches so they re-evaluate from our patched bootstrap
try {
